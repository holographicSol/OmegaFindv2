[OmegaFindv2] Multiprocessed and Asynced.
 ...
 [Scan Techniques]
 [--de-scan]    [Attempt to ascertain if file(s) suffix matches its contents]
 [--type-scan]  [Scan and compare files to known suffix/buffer relationships]
                [--suffix]         [Suffix resolves to buffer data in DB]
                [--custom-suffix]  [Select a custom suffix group]
                [--group-suffix]   [Suffix(s) resolve to buffer data in DB]
                                   [archive]
                                   [audio]
                                   [book]
                                   [code]
